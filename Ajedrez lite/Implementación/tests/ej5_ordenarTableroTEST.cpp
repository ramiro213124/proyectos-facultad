...
TEST(ordenarTableroTEST, ordenarPosicionrara) {
    tablero t = {
            {cTORRE_N, cVACIA,  cALFIL_B, cVACIA,  cREY_N,  cALFIL_N, cVACIA,  cTORRE_N},
            ...
            {cPEON_B,  cPEON_B, cPEON_B,  cPEON_B, cPEON_B, cPEON_B,  cPEON_B, cPEON_B},
            {cTORRE_B, cVACIA,  cALFIL_B, cVACIA,  cREY_B,  cALFIL_N, cVACIA,  cTORRE_B},
    };
    tablero t_ord = {
            {cALFIL_B, cVACIA,  cALFIL_N, cVACIA,  cTORRE_N, cTORRE_N, cVACIA,  cREY_N},
            {cPEON_N,  cPEON_N, cPEON_N,  cVACIA, cPEON_N,  cPEON_N,  cPEON_N, cPEON_N},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cVACIA,   cVACIA,   cVACIA,  cVACIA},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cVACIA,   cVACIA,   cVACIA,  cVACIA},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cVACIA,   cVACIA,   cVACIA,  cVACIA},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cPEON_N,   cVACIA,   cVACIA,  cVACIA},
            {cPEON_B,  cPEON_B, cPEON_B,  cPEON_B, cPEON_B,  cPEON_B,  cPEON_B, cPEON_B},
            {cALFIL_B, cVACIA,  cALFIL_N, cVACIA,  cTORRE_B, cTORRE_B, cVACIA,  cREY_B},
    };
    tablero t_ord1 = {
            {cALFIL_N, cVACIA,  cALFIL_B, cVACIA,  cTORRE_N, cTORRE_N, cVACIA,  cREY_N},
            {cPEON_N,  cPEON_N, cPEON_N,  cVACIA, cPEON_N,  cPEON_N,  cPEON_N, cPEON_N},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cVACIA,   cVACIA,   cVACIA,  cVACIA},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cVACIA,   cVACIA,   cVACIA,  cVACIA},
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cVACIA,   cVACIA,   cVACIA,  cVACIA},
    ...
    tablero t_ord2 = {
            ...
            {cVACIA,   cVACIA,  cVACIA,   cVACIA,  cPEON_N,   cVACIA,   cVACIA,  cVACIA},
            {cPEON_B,  cPEON_B, cPEON_B,  cPEON_B, cPEON_B,  cPEON_B,  cPEON_B, cPEON_B},
            {cALFIL_N, cVACIA,  cALFIL_B, cVACIA,  cTORRE_B, cTORRE_B, cVACIA,  cREY_B},
    };
    tablero t_ord3 = {
            {cALFIL_N, cVACIA,  cALFIL_B, cVACIA,  cTORRE_N, cTORRE_N, cVACIA,  cREY_N},
            {cPEON_N,  cPEON_N, cPEON_N,  cVACIA, cPEON_N,  cPEON_N,  cPEON_N, cPEON_N},
    ...
    posicion p = make_pair(t, BLANCO);
    ordenarTablero(p);
    EXPECT_TRUE((tableroActual(p)==(t_ord)) || (tableroActual(p)==(t_ord1)) || (tableroActual(p)== (t_ord2)) || (tableroActual(p)== (t_ord3)));
}
